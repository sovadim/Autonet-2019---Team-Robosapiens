...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/vadim/Projects/Autonet-2019---Team-Robosapiens/source/src/control)
  set(control_DEVEL_PREFIX /home/vadim/Projects/Autonet-2019---Team-Robosapiens/source/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/vadim/Projects/Autonet-2019---Team-Robosapiens/source/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vadim/Projects/Autonet-2019---Team-Robosapiens/source/src/control/${idir}'.  ${_report}")
    endif()
