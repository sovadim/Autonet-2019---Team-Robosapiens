...
size = 64
SIGN_FORWARD = cv2.resize(cv2.imread('src/vision_module/src/images/signs/fw.jpg'), (size, size))
SIGN_LEFT = cv2.resize(cv2.imread('src/vision_module/src/images/signs/left.jpg'), (size, size))
SIGN_RIGHT = cv2.resize(cv2.imread('src/vision_module/src/images/signs/right.jpg'), (size, size))
SIGN_FORWARD_AND_LEFT = cv2.resize(cv2.imread('src/vision_module/src/images/signs/fw_le.jpg'), (size, size))
SIGN_FORWARD_AND_RIGHT = cv2.resize(cv2.imread('src/vision_module/src/images/signs/fw_ri.jpg'), (size, size))
SIGN_BLOCK = cv2.resize(cv2.imread('src/vision_module/src/images/signs/block.jpg'), (size, size))
